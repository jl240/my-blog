...
# Gaining Intuition for Matrix Multiplication
...
$$
\text{Recipe 1:} 180 \, \text{g of rice}, 300 \, \text{g of beef}
\text{Recipe 2:} 150 \, \text{g of pasta}, 350 \, \text{g of sausage}
\text{Calories:} 4 \, \text{cal/g of carbs}, 9 \, \text{cal/g of fats}
$$
...
\right]}
\quad
\overset{\text{Calorie content}}{\left[
\begin{array}{c}
4 \, \text{cal/g}
9 \, \text{cal/g}
\end{array}
...
$$
\overset{A}{\left[ \begin{matrix} 180 & 300 \\ 150 & 350 \end{matrix} \right]}
\quad
\overset{C}{\left[ \begin{matrix} 4 \\ 9 \end{matrix} \right]}
$$
...
$$
\overset{T \, (\text{Total calories})}{\left[
\begin{array}{c}
3420 \\
3750
\end{array}
...
$$
	A carb  fat  protein		C
	R1: [ 180	300   50		[ 4 carbs cal/g
	R2:   150	350   100]		  9 fats cal/g
	R3:   130	290…			  4 protein cal/g ]

	Visualiziation of A * C:
