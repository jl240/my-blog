...
In case you need a refresher for the arithmetic operation itself, here's a [video](https://www.youtube.com/watch?v=20pycEx1dSI) that uses a different example.
...
\left[
\begin{array}{cc}
\textcolor{green}{180} & \textcolor{blue}{300} \\
150 & 350
\end{array}
\right]
\times
...
\right]
=
\textcolor{green}{180} \, (\text{carb}) \times \textcolor{green}{4} \, (\text{cal}) + \textcolor{blue}{300} \, (\text{fat}) \times \textcolor{blue}{9} \, (\text{cal}) = \textcolor{green}{720} \, \text{cal} + \textcolor{blue}{2700} \, \text{cal} = \textcolor{red}{3420} \, \text{cal}
$$
...
\begin{array}{cc}
180 & 300 \\
\textcolor{green}{150} & \textcolor{blue}{350}
\end{array}
\right]
\times
\left[
...
\right]
=
\textcolor{green}{150} \, (\text{carb}) \times \textcolor{green}{4} \, (\text{cal}) + \textcolor{blue}{350} \, (\text{fat}) \times \textcolor{blue}{9} \, (\text{cal}) = \textcolor{green}{600} \, \text{cal} + \textcolor{blue}{3150} \, \text{cal} = \textcolor{orange}{3750} \, \text{cal}
$$
...
![](assets/images/cpu_doing_Math.webp)
