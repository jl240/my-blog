...
$$
\overset{\text{\large Amounts}}{\left[
\begin{array}{cc}
180\text{g} & 300\text{g} \\
150\text{g} & 350\text{g}
\end{array}
\right]}
\quad
\overset{\text{\large Calorie content}}{\left[
\begin{array}{c}
4 \, \text{cal/g} \\
9 \, \text{cal/g}
\end{array}
...
$$
\overset{\text{\large A}}{\left[ \begin{matrix} 180 & 300 \\ 150 & 350 \end{matrix} \right]}
\quad
\overset{\text{\large C}}{\left[ \begin{matrix} 4 \\ 9 \end{matrix} \right]}
$$
